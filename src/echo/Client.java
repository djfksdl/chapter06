...
public class Client {
	public static void main(String[] p) throws IOException {
		...
		socket.connect(new InetSocketAddress("192.168.0.29",10001));	
...
/*		OutputStream out = new FileOutputStream("C:\\javaStudy\\MS949-copy.txt");//여기까지는 빨대 꼽은 상태 -> 꼽는순간 안에 내요잉 초기화되어서 같은 파일이름으로 하면 못읽음(일부러 실험한거)
		OutputStreamWriter osw = new OutputStreamWriter(out,"MS949"); //MS949로 바꿔주세요
		BufferedWriter bw = new BufferedWriter(osw); 이전에 썼던거랑 비교하려고 놓음*/
